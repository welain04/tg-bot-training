...
AI_NOT_CONFIGURED_TEXT = (
    "💬 <b>Вопрос об услугах</b>\n\n"
    "Помощник не настроен на сервере: не задан <code>GROQ_API_KEY</code>.\n"
    "Добавьте ключ в <code>.env</code> (локально) или в секреты Fly "
    "(<code>.\\scripts\\fly-secrets.ps1</code>).\n\n"
    "Пока можно записаться на приём или связаться с клиникой через «Контакты»."
)
